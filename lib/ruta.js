...
export function evaluarRuta(c, hoy = new Date()) {
  ...
  let siguienteAccion = `Acudir a: ${principal.nombre}, con la orden del clínico (consulta y prueba confirmatoria), antes del ${fechaLimite}.`
  ...
  if (c.intentos === '2') {
    ...
    escalamiento = `Automatización detenida tras 2 intentos fallidos. La navegadora llama o la ve en persona antes del ${fechaLimite}. No más recordatorios automáticos.`
  }
