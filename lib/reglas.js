...
export const VERSION = 'v0.1.2 · 13-sep-2026'
...
export const REGLAS = [
  ...
  { id: 'R05', cond: 6, sev: 'BLOQUEA', titulo: 'El pagador recibe nombres y teléfonos de pacientes',
    test: t => tiene(t.datosPagador, 'nombre_contacto'),
    porque: 'Aunque no traiga resultados, una lista de "pacientes del piloto de diabetes" dice quién tiene un resultado anormal. Es un dato de salud con otro nombre, y el Blueprint solo permite números totales al patrocinador. (Subió de RIESGO a BLOQUEA en v0.1.2, después de la re-prueba con persona.)',
    fuente: 'Blueprint T2, Condición 6 · LFPDPPP 2025, art. 2: datos sensibles incluyen estado de salud presente y futuro',
    cura: 'Quitar del contrato la cláusula que entrega el listado de pacientes con su teléfono. Para pagar, basta el número de pacientes atendidas, sin nombres.' },
