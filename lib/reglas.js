...
export const VERSION = 'v0.1 · 13-sep-2026'

export const CONDICIONES = {
  1: 'Frontera clínica',
  2: 'Traspaso con dueña',
  3: 'Escalamiento humano',
  4: 'Acceso honesto',
  5: 'Operación financiada y medible',
  6: 'Cláusula sombra',
}
...
export const CAMPOS = {
  ...
  datosPagador: { multi: true, label: 'Qué datos recibe el pagador', opciones: { agregados: 'Solo cifras agregadas', nombre_contacto: 'Nombre y teléfono de cada paciente', estado_caso: 'Estado del caso de cada paciente', resultado: 'Resultado del tamizaje de cada paciente', barreras: 'Barreras de cada paciente (costo, transporte…)' } },
  celdaMinima: { label: 'Tamaño mínimo de grupo en las cifras agregadas', opciones: { '0': 'No se define', '5': '5 personas', '11': '11 personas o más' } },
...
export const REGLAS = [
  ...
  { id: 'R04', cond: 6, sev: 'BLOQUEA', titulo: 'El pagador ve señales de salud de cada paciente',
    ...
    cura: 'El pagador recibe solo un reporte mensual agregado (acciones completadas, minutos de navegadora, barreras por tipo) con grupos de 11 o más.' },
  ...
  { id: 'R19', cond: 5, sev: 'VERIFICAR', titulo: 'El pagador vende lo que la navegación puede terminar recetando',
    ...
    cura: 'Reporte agregado del destino de las referencias; revisión si la mayoría termina en el pagador.' },
...
export const DATOS = [
  ...
  ['agregados', 'Cifras agregadas del programa'],
]
